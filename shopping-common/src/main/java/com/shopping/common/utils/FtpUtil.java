...
public class FtpUtil {
    ...
    private static final String basePath="E:\\ftpImg";
    public static final String filePath="shopping";
    ...
    public void upload(String ftpFileName, InputStream in) throws IOException {
        if (null==in){
            throw new IOException("Can't upload '" + "'.inputStream doesn't exist.");
        }
        try {
...
//        ftpUtil.upload("E:\\ftpImg\\"+IDUtils.genImageName()+".jpg", new File("D:\\aa.jpg"));
        ftpUtil.upload(IDUtils.genImageName()+".jpg", new File("D:\\aa.jpg"));
